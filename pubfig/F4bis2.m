...
text(-.2,-.45,['{\Delta}EMG_{off(+)} = \beta_{adapt} {\Delta}EMG_{on(' char(8211) ')} ' char(8211) '\beta_{no-adapt} {\Delta}EMG_{on(+)}'],'Clipping','off','Fontsize',9)
pC.XAxis.Label.Position(2)=-.1;

%%
set(findobj(fB,'Type','Axes'),'FontName','OpenSans')
set(findobj(fB,'Type','Text'),'FontName','OpenSans')
%saveFig2(fB,'./','Fig4bis2',1)
export_fig ./Fig4bis2.png -png -transparent -r600