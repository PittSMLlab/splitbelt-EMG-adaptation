...
for k=1:2
    ...
    if k==2
        ...
        lg=legend(ll(end-1:end),{'early split (+)','tied'},'Location','NorthEast');
        lg.Box='off';
    ...
    txt.Position(1)=txt.Position(1)-.35;
    txt.String={'early'; 'split (+)'};
    txt.FontSize=6;
...
%  saveFig2(fh,'./',name,0)
export_fig ./F1bis.png -png -transparent -r600