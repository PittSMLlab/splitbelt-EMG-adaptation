...
for i=1:Nfolds
    ...
    [model] = sPCAv6(Y(i:Nfolds:end,:),dynOrder,forcePCS,nullBD,outputUnderRank);
    %Transform J, B to describe dynamics for every sample, instead of
    %every Nfolds samples.
...
%     end
    ...
    %Re-compute X to get a state estimate for every sample, instead of
    %1-every-Nfolds
